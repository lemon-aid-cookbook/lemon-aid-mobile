...
export const GetAnotherProfile = defineAction<any>('GET_ANOTHER_PROFILE_REQUEST');
export const GetAnotherProfileSuccess = defineAction<any>('GET_ANOTHER_PROFILE_SUCCESS');
export const GetAnotherProfileFailed = defineAction<any>('GET_ANOTHER_PROFILE_FAILED');
...
export const GetDetailPostSuccessNotNav = defineAction<any>('GET_DETAIL_SUCCESS_NOT_NAV')
